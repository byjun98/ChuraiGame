    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('steam_id', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='스팀 ID')),
                ...
                ('similar_users', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL)),
